...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Postulantes seleccionado</h3>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-striped" id="table1">
                ...
                <tbody>
                    <?php
                    $dato = Postulante::verPostulanteSeleccionado();
                    ...
                    foreach ($dato as $row) {
                        ...
                        $color = $row->DATestado == "no paso"? "danger":"success";
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-<?php echo $color ?>"><?php echo $row->DATestado ?></span>
                            </td>
